	...
	//View MeterUnit
		public String ViewMeterunit() { 
				...
				try { 
					...
					output = "<table class='table table-hover MeeterReadTable'><tr class ='Tabletr'><th>User ID</th><th>Full Name</th>" + "<th>City</th>" + "<th>Mobile Number</th><th>Unit</th><th>Remark</th>" + "<th>Create Bill</th></tr>"; 
					...
					while (rs.next()) { 
						...
						// buttons
						output += "<td><input id='calBill' name='calBill' type='button' value='Create Bill' class='calBill btn btn-info'></td></tr>"; 
					...
					output += "</table>"; 
					out = "{\"status\":\"success\", \"data\":\""+output+"\"}";
					return out;
				} 
					...
					out = "{\"status\":\"error\", \"data\":\"Error while reading the item.\"}";
					return out; 
				} 
		...
		//View Bills
				public String ViewBills() { 
						...
						try { 
							...
							output = "<table class='table table-hover MeeterReadTable'><tr class ='Tabletr'><th>User ID</th><th>Full Name</th>" + "<th>City</th>" + "<th>Mobile Number</th><th>Unit</th><th>Remark</th><th>Price</th><th>Payment</th><th>Date</th>" + "<th>Update Bill</th></tr>"; 
							...
							while (rs.next()) { 
								...
								// buttons
								output += "<td><input id='updateBill' name='updateBill' type='button' value='Update Bill' class='updateBill btn btn-info'></td></tr>"; 
		...
		public String CalBill(String UserID, String FullName, String City, String MobileNumber, String Unit, String Remark, String Price1_30, String Price30_60, String Price60_90, String Price90) { 
			...
			try { 
				...
				output = "{\"status\":\"Error while Create Bill\"}"; 
		...
		public String UpdateBill(String UserID, String Price, String Remark) { 
			...
			try { 
				...
				output = "{\"status\":\"Error while Update the item\"}"; 
				System.err.println(e.getMessage()); 
			} 
		...
		public String LostUser() { 
			...
			try { 
				...
				output = "<table class='table table-hover losttable'><tr class ='Tabletr'><th>ID</th><th>User ID</th><th>Full Name</th><th>Address</th>" + "<th>City</th>" + "<th>Mobile Number</th><th>Email</th><th>Power Plant</th><th>Remark</th>" + "<th>Update</th></tr>"; 
				...
				while (rs.next()) { 
					...
					// buttons
					output += "<td><input id='deletelost' name='deletelost' type='button' value='Lost Connection' class='deletelost btn btn-danger'></td></tr>"; 
				} 
